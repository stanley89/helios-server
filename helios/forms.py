...
class ElectionTimeExtensionForm(forms.Form):
  voting_extended_until = forms.SplitDateTimeField(help_text = 'UTC date and time voting extended to',
                                   widget=forms.widgets.SplitSelectDateTimeWidget, required=False)
